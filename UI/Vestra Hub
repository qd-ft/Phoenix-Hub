...
function library:AddSettings()
    ...
    Credits:AddLabel({ Content = "UI Made By peepingonya (Xandu)", Flag = "Credit1"})
    Credits:AddLabel({ Content = "Owner: qdft", Flag = "Credit2"})
    Credits:AddLabel({ Content = "Founder: wolfyz16", Flag = "Credit3"})
